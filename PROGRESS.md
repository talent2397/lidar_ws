...
2. 【补偿器改造（已完成 v6c）】113628 实机复测：运动段 Δz0 从 ±8.2cm 降到 **±4.4cm**、
...
- **真实转弯已实机验证到运动 Δz0 ±4.4cm（113628 + v6c）**；剩余 >1.5 rad/s
