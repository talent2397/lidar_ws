...
def main():
    ...
    if ov_b < 50:
        ...
        print("ℹ️ 重叠率低: 本机器人两台雷达为互补覆盖设计"
              "(lidar1 主视地面/前向, lidar2 主视上方/后向), 低重叠属正常。")
        print("   请目视确认: RViz 中两片点云应拼接成一个完整场景(无整体旋转/镜像),")
        print("   边缘在交界处自然衔接; 若出现整体 90°/180° 错位才是外参问题。")
    elif ov_map < 30:
        print("✅ 存在部分重叠且基本对齐; 结合互补覆盖设计判定为正常")
    else:
        print("✅ 对齐良好: 两台雷达点云在 odom 系下重叠明显(同向覆盖设计)")
    return 0
